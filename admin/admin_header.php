    ...
    <aside class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 border-r border-slate-200 bg-white">
        <div class="flex flex-col flex-grow pt-5 overflow-y-auto">
            ...
            <nav class="flex-1 px-4 space-y-1 bg-white">
                ...
                <a href="testimonials.php" class="flex items-center px-4 py-2 text-xs font-medium rounded-lg transition-all duration-300 <?php echo is_active('testimonials.php'); ?>">
                    <svg class="mr-3 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
